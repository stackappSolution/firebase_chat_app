  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ContactController>(
      ...
      initState: (state) async {
        ...
        logs('FCM TOKEN get chat screen -->$fcmToken');
      },
      builder: (controller) {
        return SafeArea(
            child: Scaffold(
    ...
    if (controller.searchValue) {
      return AppAppBar(
        ...
        title: SizedBox(
          height: 30,
          child: TextFormField(
            controller: chatViewModel!.searchController,
            onChanged: (value) {
              chatViewModel!.filterContacts(value);
            },
  ...
  buildContactList(ContactController controller) {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        return (snapshot.hasData && documents.isNotEmpty)
            ? ListView.builder(
          ...
          itemCount: controller.isSearching
              ...
              : documents.length,
                itemBuilder: (context, index) {
                  logs('Documentssss --> ${documents[index].data()}');
                  ...
                  chatViewModel!.contactList.add(receiverNumber);
                      ...
                      child: ListTile(
                        ...
                        trailing: StreamBuilder(
                          ...
                          builder:
                            ...
                            return AppText(
                              chatViewModel!.contactList[index].toString(),

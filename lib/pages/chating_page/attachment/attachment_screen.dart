...
class AttachmentScreen extends StatelessWidget {
  ...
  Stack photoShowView(AttachmentController controller, BuildContext context) =>
      Stack(
        children: [
          Container(
  ...
  Stack videoShowView(AttachmentController controller, BuildContext context) =>
      Stack(
        children: [
          Container(
            padding: EdgeInsets.all(20.px),
  ...
  Stack documentShowView(
          AttachmentController controller, BuildContext context) =>
      Stack(
        children: [
          Container(
            padding: EdgeInsets.all(20.px),
              ...
              child: Column(children: [
                ...
                Padding(
                  ...
                  child: AppTextFormField(
                    controller: attachmentViewModel!.textController,
                    suffixIcon: IconButton(
                      onPressed: () => attachmentViewModel!.documentButtonTap(
                          controller,
  ...
  Stack audioShowView(AttachmentController controller, BuildContext context) =>
      Stack(
        children: [
          Padding(

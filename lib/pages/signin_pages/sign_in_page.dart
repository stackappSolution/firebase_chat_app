...
Container buildSignInpage(String countryCode, String phoneNumber,
    BuildContext context, SignInController controller, SignInViewModel signInViewModel) =>
    Container(
            ...
            if (signInViewModel.isValidNumber != true)
              ...
              Align(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    goToVerifyPage(
                        arguments: "${signInViewModel
                            .countryCode}""${signInViewModel.phoneNumber.text}");
                  },
                  style: ButtonStyle(

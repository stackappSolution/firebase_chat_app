          ...
          return SafeArea(
            child: Scaffold(
                body: buildSignInpage(signInViewModel!.countryCode,
                    signInViewModel!.phoneNumber.text, context, controller, signInViewModel!)),
          );
        });
  }
}

Container buildSignInpage(String countryCode, String phoneNumber, BuildContext context,
                ...
                Expanded(
                  ...
                  Container(
                      ...
                      child: AppTextFormField(
                          ...
                          labelStyle: TextStyle(color: AppColorConstant.appTheme, fontSize: 20.px),
                          ...
                          validator: (value) {
                            ...
                            } else if (signInViewModel.isValidMobileNumber(value)) {
              ...
              if (signInViewModel.isValidNumber != true)
                Align(
                    ...
                    child: ElevatedButton(
                        ...
                        child:
                            AppText('Continue', fontSize: 22.px, color: AppColorConstant.appWhite)))
              else
                Align(
                    alignment: Alignment.center,
                    child: ElevatedButton(
                        onPressed: () async {
                          goToVerifyPage(
                              arguments: "${signInViewModel.countryCode}"

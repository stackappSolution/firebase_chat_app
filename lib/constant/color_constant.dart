...
class AppColorConstant {
  ...
  static const Color yellow = Color(0xFFFFCE39);
  static const Color blackshade = Color(0xFF323846);
  static const Color lightred = Color(0xFFFC6868);
  static const Color blueaccent = Color(0xFF80C1D3);
